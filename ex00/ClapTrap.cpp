...
{
    std::cout << "Default constructor with no arguements is called" << std::endl;
    return ;
}

ClapTrap::ClapTrap(std::string name) : _name(name), _hp(10), _energy(10), _attack_dmg(0)
{
    std::cout << "Constructor with string as a parameter is called" << std::endl;
    return ;
}
...
void ClapTrap::takeDamage(unsigned int amount)
{
    ...
    if (this->_hp < amount)
        ...
        this->_hp -= amount;
    std::cout << "Now ClapTrap " << this->_name << " has " << this->_hp << " hit points of health" << std::endl;
    return ;
}
...
void ClapTrap::beRepaired(unsigned int amount)
{
    ...
    std::cout << "ClapTrap " << this->_name << " has been repaired and gets " << amount << " hit points back" << std::endl;
    this->_hp += amount;
    if (this->_hp > 10)
        this->_hp = 10;
    this->_energy--;
